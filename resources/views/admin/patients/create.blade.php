...
<main id="main" class="main">
    ...
    <div class="pagetitle mb-4">
        <h1 class="fw-bold mb-2">Thêm bệnh nhân mới</h1>
        <nav>
            ...
            <div class="col-lg-8 mx-auto">
                <div class="card shadow-sm border-0 rounded-4">
                    <div class="card-body p-5">
                        ...
                        <form action="{{ route('patients.store') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="idCard"
                                           class="form-control form-control-lg shadow-sm border-0 rounded-3"
                                           placeholder="Nhập số CCCD" value="{{ old('idCard') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="checkinDate"
                                           class="form-control form-control-lg shadow-sm border-0 rounded-3"
                                           value="{{ old('checkinDate', date('Y-m-d')) }}">
                            ...
                            <div class="d-flex justify-content-end align-items-center mt-5 gap-3">
                                ...
                                <button type="submit" class="btn btn-gradient px-4 py-2 rounded-3">
                                    <i class="fas fa-save me-2"></i> Lưu bệnh nhân
                                </button>
                            </div>
                        </form>
